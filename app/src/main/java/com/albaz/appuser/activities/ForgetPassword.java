...
public class ForgetPassword extends AppCompatActivity {
    ...
    private void forgetPassword() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URLHelper.FORGET_PASSWORD, object, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                validation="reset";
                JSONObject userObject=response.optJSONObject("appuser");
                id= String.valueOf(userObject.optInt("id"));
                server_opt = userObject.optString("otp");
                email.setFocusable(false);
                email.setFocusableInTouchMode(false); // appuser touches widget on phone with touch screen
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URLHelper.RESET_PASSWORD, object, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    startActivity(new Intent(ForgetPassword.this,ActivityPhone.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                    finish();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public void onBackPressed() {
        if(fromActivity){
            Intent mainIntent = new Intent(ForgetPassword.this, ActivityPhone.class);
            mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(mainIntent);
            ForgetPassword.this.finish();
        }else {
