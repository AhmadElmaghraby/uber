...
import com.albaz.appuser.activities.AddCard;
...
import com.albaz.appuser.helper.DirectionsJSONParser;
...
import com.albaz.appuser.utils.MyCheckbox;
...
//    }
    ...
    private void checkStatus() {
        ...
        if (isInternet) {
            ...
            final JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URLHelper.REQUEST_STATUS_CHECK_API, "", new Response.Listener<JSONObject>() {
                @Override
                public void onResponse(JSONObject response) {
